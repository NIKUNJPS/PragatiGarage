...
The invoice **PDF** embeds the logo you upload inside the app, not this file.
So also upload the same image once in the app:

1. Sign in as the owner (admin).
2. Go to **Settings → Garage** (or finish the **Setup wizard**).
3. Click **Upload logo** and choose your logo image.
